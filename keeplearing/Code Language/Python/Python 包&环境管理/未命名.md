...
![](resource/python_manage_tool.png)

近年来，由于Rust语言的火热，很多构建、管理工具都被使用 Rust 语言重构，于是我准备去寻找一款集 Python 的包和环境管理一体的工具。接下来我将介绍 Python 生态系统中最有希望成为 Python 的 Cargo 的工具---uv。
...
此时可以使用 `uv python install` 命令安装指定版本的 python
...
项目结构如下：
![](resource/Pasted%20image%2020241218173111.png)
